...
whetherWeatherSpace.components.singleCard = (index) => {
  ...
  const elPTempTitle = document.createElement("p");
  elPTempTitle.innerText = "Temp";
  ...
  const elPWindTitle = document.createElement("p");
  elPWindTitle.innerText = "Wind";
  ...
  elDivDailyStats.appendChild(elDivPTemp).appendChild(elPTempTitle);
  elDivDailyStats.appendChild(elDivPTemp).appendChild(elPTemp);
  elDivDailyStats.appendChild(elDivPWind).appendChild(elPWindTitle);
